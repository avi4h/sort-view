...
function App() {
  ...
  return (
    <div className="bg-white text-gray-900 min-h-screen flex overflow-hidden">
      <aside className="w-1/3 bg-gray-100 overflow-y-auto h-screen" style={{ scrollbarWidth: 'thin' }}>
